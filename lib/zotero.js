...
function exportCurrentItemGroup() {
    ...
    corpusID.then(function(id) {
        ...
        console.error(error);
        console.error("Corpus ID could not be acquired. Is the server running?");
    });
}
...
function traverseAndExportItemGroup(itemGroup, corpusID) {
    ...
    console.log(itemGroups.map(function(d) {
    ...
    function queueExport(itemGroup) {
        ...
        console.log("Queueing export of " + groupName + ": " + items.length + " items");
